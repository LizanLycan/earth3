...
export interface RateFutureVaultInterface extends utils.Interface {
  functions: {
...
export interface RateFutureVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RateFutureVaultInterface;
