...
export interface HybridFutureVaultInterface extends utils.Interface {
  functions: {
  ...
  decodeFunctionResult(functionFragment: "getIBTRate", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getNextPeriodIndex",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "RewardTokenRedeemed(address,uint256)": EventFragment;
    "RewardsHarvested()": EventFragment;
    "RewardsRecipientUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "RewardTokenRedeemed"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RewardsHarvested"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RewardsRecipientUpdated"): EventFragment;
...
export interface RewardTokenRedeemedEventObject {
  _token: string;
  _amount: BigNumber;
}
export type RewardTokenRedeemedEvent = TypedEvent<
  [string, BigNumber],
  RewardTokenRedeemedEventObject
>;

export type RewardTokenRedeemedEventFilter =
  TypedEventFilter<RewardTokenRedeemedEvent>;

export interface RewardsHarvestedEventObject {}
export type RewardsHarvestedEvent = TypedEvent<[], RewardsHarvestedEventObject>;

export type RewardsHarvestedEventFilter =
  TypedEventFilter<RewardsHarvestedEvent>;

export interface RewardsRecipientUpdatedEventObject {
  _recipient: string;
}
export type RewardsRecipientUpdatedEvent = TypedEvent<
  [string],
  RewardsRecipientUpdatedEventObject
>;

export type RewardsRecipientUpdatedEventFilter =
  TypedEventFilter<RewardsRecipientUpdatedEvent>;
...
export interface HybridFutureVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HybridFutureVaultInterface;
  ...
  filters: {
    ...
    "RewardTokenAdded(address)"(_token?: null): RewardTokenAddedEventFilter;
    RewardTokenAdded(_token?: null): RewardTokenAddedEventFilter;

    "RewardTokenRedeemed(address,uint256)"(
      _token?: null,
      _amount?: null
    ): RewardTokenRedeemedEventFilter;
    RewardTokenRedeemed(
      _token?: null,
      _amount?: null
    ): RewardTokenRedeemedEventFilter;

    "RewardsHarvested()"(): RewardsHarvestedEventFilter;
    RewardsHarvested(): RewardsHarvestedEventFilter;

    "RewardsRecipientUpdated(address)"(
      _recipient?: null
    ): RewardsRecipientUpdatedEventFilter;
    RewardsRecipientUpdated(
      _recipient?: null
    ): RewardsRecipientUpdatedEventFilter;
