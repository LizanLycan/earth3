...
export interface RewardsFutureVaultInterface extends utils.Interface {
  functions: {
...
export interface RewardsFutureVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardsFutureVaultInterface;
