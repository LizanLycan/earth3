...
export interface LidoFutureVaultInterface extends utils.Interface {
  functions: {
...
export interface LidoFutureVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LidoFutureVaultInterface;
