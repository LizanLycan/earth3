...
import type {
  FutureVault,
  FutureVaultInterface,
} from "../../../contracts/apwine/FutureVault";
...
export class FutureVault__factory {
  static readonly abi = _abi;
  static createInterface(): FutureVaultInterface {
    return new utils.Interface(_abi) as FutureVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FutureVault {
    return new Contract(address, _abi, signerOrProvider) as FutureVault;
  }
}
