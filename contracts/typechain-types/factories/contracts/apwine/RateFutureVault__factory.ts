...
import type {
  RateFutureVault,
  RateFutureVaultInterface,
} from "../../../contracts/apwine/RateFutureVault";
...
export class RateFutureVault__factory {
  static readonly abi = _abi;
  static createInterface(): RateFutureVaultInterface {
    return new utils.Interface(_abi) as RateFutureVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RateFutureVault {
    return new Contract(address, _abi, signerOrProvider) as RateFutureVault;
  }
}
