...
import type {
  RewardsFutureVault,
  RewardsFutureVaultInterface,
} from "../../../contracts/apwine/RewardsFutureVault";
...
export class RewardsFutureVault__factory {
  static readonly abi = _abi;
  static createInterface(): RewardsFutureVaultInterface {
    return new utils.Interface(_abi) as RewardsFutureVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): RewardsFutureVault {
    return new Contract(address, _abi, signerOrProvider) as RewardsFutureVault;
  }
}
