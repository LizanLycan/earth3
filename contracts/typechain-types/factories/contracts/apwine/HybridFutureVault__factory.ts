...
import type {
  HybridFutureVault,
  HybridFutureVaultInterface,
} from "../../../contracts/apwine/HybridFutureVault";
...
export class HybridFutureVault__factory {
  static readonly abi = _abi;
  static createInterface(): HybridFutureVaultInterface {
    return new utils.Interface(_abi) as HybridFutureVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): HybridFutureVault {
    return new Contract(address, _abi, signerOrProvider) as HybridFutureVault;
  }
}
